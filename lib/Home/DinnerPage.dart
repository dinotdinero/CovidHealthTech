...
class DinnerPage extends StatefulWidget {
  final DinnerModel dinnerModel;
  DinnerPage({this.dinnerModel});
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.dinnerModel.recipe.toString(),
                            style: boldTextStyle,
                          ),
                          SizedBox(
                            height: 10.0,
                          ...
                          Text(
                            widget.dinnerModel.procedure.toString(),
                            style: boldTextStyle,
                          ),
                        ],
                      ),
