...
import 'package:flutter_appcovidhealth2/Home/dinnerfav.dart';
...
import 'package:flutter_appcovidhealth2/widgets/dinnerSearchbox.dart';
...
class FoodDinner extends StatefulWidget {
  @override
  _FoodDinnerState createState() => _FoodDinnerState();
}

class _FoodDinnerState extends State<FoodDinner> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () {
            Route route = MaterialPageRoute(builder: (c) => DinnerFav());
        ...
        body: CustomScrollView(
          slivers: [
            SliverPersistentHeader(
                pinned: true, delegate: DinnerSearchBoxDelegate()),
...
Widget sourceInfo(DinnerModel model, BuildContext context,
    {Color background, removeCartFunction}) {
  return InkWell(
    onTap: () {
      Route route =
          MaterialPageRoute(builder: (c) => DinnerPage(dinnerModel: model));
      Navigator.pushReplacement(context, route);
    },
