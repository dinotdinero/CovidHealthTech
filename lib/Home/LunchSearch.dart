...
class LunchSearchProduct extends StatefulWidget {
  @override
  _LunchSearchProductState createState() => new _LunchSearchProductState();
}

class _LunchSearchProductState extends State<LunchSearchProduct> {
            ...
            return snap.hasData
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      LunchModel model =
                          LunchModel.fromJson(snap.data.documents[index].data);
