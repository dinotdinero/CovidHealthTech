...
class FoodSearchProduct extends StatefulWidget {
  @override
  _FoodSearchProductState createState() => new _FoodSearchProductState();
}

class _FoodSearchProductState extends State<FoodSearchProduct> {
            ...
            return snap.hasData
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      FoodModel model =
                          FoodModel.fromJson(snap.data.documents[index].data);
